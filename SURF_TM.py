# SURF/KNN/RANSAC template matching
...
# init feature detector SURF
surf_detector = cv2.xfeatures2d.SURF_create(hessianThreshold=100)
# init feature matcher KNN
matcher = cv2.DescriptorMatcher_create("BruteForce")
ratio_thresh = 0.80

# find feature in the object template
kp_obj, des_obj = surf_detector.detectAndCompute(template_img, None)
...
while True:
    ...
    kp_scene, des_scene = surf_detector.detectAndCompute(scene_img, None)
